(function(e){
    ...
    u.e=function(e){
        ...
        o[e]?t.push(o[e]):0!==o[e]&&r[e]&&t.push(o[e]=new Promise((function(t,r){
            ...
            f.rel="stylesheet", f.type="text/css", f.onload=t, f.onerror=function(t){
                var n=t&&t.target&&t.target.src||a,i=new Error("Loading CSS chunk "+e+" failed.\n("+n+")");
    ...
    0:function(e,t,r){
        ...
        r("c3a6");
        var a=r("ad06"),
            i=Object(n["k"])({name:"NavBarIcon",components:{VanIcon:a["a"]},props:{name:{type:String,required:!0}}});
        i.render=o;
        t["a"]=i
    },"4ece":function(e,t){
        ...
        var s={class:"layout-container"},d=Object(n["i"])(" 首页 "),l=Object(n["i"])(" 分类 "),f=Object(n["i"])(" 我的 ");
        Object(n["A"])();
        var g=u((function(e,t,r,o,a,i){
                var c=Object(n["G"])("nav-bar-icon"),g=Object(n["G"])("van-popover"),p=Object(n["G"])("van-nav-bar"),
                    A=Object(n["G"])("router-view"),h=Object(n["G"])("van-tabbar-item"),m=Object(n["G"])("van-tabbar");
                return Object(n["z"])(), Object(n["g"])("div",s,[Object(n["R"])(Object(n["j"])(p,{
                    ...
                    default:u((function(){
                        return [Object(n["j"])(h,{replace:"",to:{name:"Home"},icon:"home-o"},{
                            default:u((function(){
                                return [d]
                            })),_:1
                        }),Object(n["j"])(h,{replace:"",to:{name:"Category"},icon:"apps-o"},{
                            default:u((function(){
                                return [l]
                            })),_:1
                        }),Object(n["j"])(h,{replace:"",to:{name:"Personal"},icon:"contact"},{
                            default:u((function(){
                                return [f]
                            })),_:1
                        })]
            ...
            })),p=(r("96cf"), r("1da1")),A=(r("d82d"), r("7278")),h=(r("a52c"), r("2ed4")),m=(r("537a"), r("ac28")),
            b=(r("5246"), r("6b41")),I=r("2af5"),v=r("0613"),C=r("5849"),E=r("ea9b"),k=Object(n["k"])({
                components:{VanNavBar:b["a"],VanTabbar:m["b"],VanTabbarItem:h["a"],VanPopover:A["a"],NavBarIcon:I["a"]},
                setup:function(){
        ...
        function i(){
            return Object(n["a"])({url:"/user",withCredentials:true})
        }

        function c(e){
            return Object(n["a"])({url:"/users/".concat(e),withCredentials})
        }

        function u(e){
            return Object(n["a"])({method:"PATCH",url:"/user",data:e,withCredentials:true})
        }

        function s(e){
            return Object(n["a"])({method:"GET",url:"/user/played",params:e,withCredentials:true})
        }

        function d(e){
            return Object(n["a"])({method:"GET",url:"/user/favorites",params:e,withCredentials:true})
        }
    },f977:function(e,t,r){
        "use strict";
